...
CREATE DATABASE IF NOT EXISTS bluedart_db;
USE bluedart_db;

-- Shipments table for Blue Dart tracking
...
-- Scans table for Blue Dart scan tracking
...
-- Delivery details table for Blue Dart delivery information
...
-- Reweigh table for Blue Dart reweigh information
...
-- Webhook audit log table for tracking all incoming webhook requests
